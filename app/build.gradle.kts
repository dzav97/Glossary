...
android {
    namespace = "com.example.glossaryy"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.glossaryy"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "1.5.2" // Update to the latest version
    }
...
dependencies {
    ...
    implementation ("androidx.navigation:navigation-compose:2.6.0-alpha01") // Sesuaikan dengan versi terbaru
